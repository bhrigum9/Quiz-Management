...
<link href="resources/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <h2>Select Question Type</h2>
      ...
      <input type="button" style="margin:10px;" onclick="location.href='question.jsp';" value="MCQ Question" />
      <input type="button" style="margin:10px;" onclick="location.href='openQuestion.jsp';" value="The Open Questions" />
      <input type="button" style="margin:10px;" onclick="location.href='associativeQuestion.jsp';" value="Associative Questions" />
